...
class UltraDB {
    ...
    #save() {
        ...
        this.#saveTimer = setTimeout(() => {
            try { writeFileSync(this.#path, JSON.stringify(this.data, null, 2)); } catch (e) {}
            this.#saveTimer = null;
        }, 50);
    }
                        ...
                        get(groupTarget, groupId) {
                            ...
                            return new Proxy(groupTarget[groupId], {
                                set(obj, key, val) {
                                    ...
                                    if (Object.keys(obj).length === 0) delete groupTarget[groupId];
                                    self.#save();
                                    return true;
                                },
                        ...
                        get(userTarget, userId) {
                            ...
                            return new Proxy(userTarget[userId], {
                                set(obj, key, val) {
                                    ...
                                    if (Object.keys(obj).length === 0) delete userTarget[userId];
                                    self.#save();
                                    return true;
                                },
                                deleteProperty(obj, key) {
